...
import { ScopeIcon, UnverifiedIcon, ExcludedIcon } from './comparisonIcons.jsx'

/** Nishonlar `COMPARISON.rows` bilan bir tartibda — qator indeksi bo'yicha. */
const PROBLEM_ICONS = [ScopeIcon, UnverifiedIcon, ExcludedIcon]
 ...
 *
 * Har qatordagi chap va o'ng kartochka BIR XIL balandlikda turadi
 * (`items-stretch`): kalta kartochka baland qo'shnisiga tenglashadi.
 *
              ...
              <div className="grid items-stretch gap-[18px] md:grid-cols-2">
                <article className="rounded-[18px] border border-line bg-raised px-7 py-[26px]">
                  <div className="flex items-center gap-2.5">
                    <ProblemIcon size={18} className="flex-shrink-0 text-faint" />
